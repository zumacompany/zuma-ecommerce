      ...
      <div className="container max-w-[1200px] px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          {data.whatsapp_number && (
            <div className="mt-6">
              <a
                href={`https://wa.me/${data.whatsapp_number.replace(/\D/g, '')}?text=${encodeURIComponent("Ola tudo bem, vim pelo website e gostaria de um produto personalizado")}`}
                target="_blank"
              ...
              >
                ...
                Deseja algum produto digital diferente?
              </a>
            </div>
          )}
