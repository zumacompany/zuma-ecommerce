...
const Icons = {
  ...
  Regions: <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
...
const nav = [
  ...
  { href: '/admin/regions', label: 'Regiões', icon: Icons.Regions },
  ...
  { href: '/admin/settings', label: 'Configurações', icon: Icons.Settings },
]
...
export default function AdminSidebar() {
  ...
  return (
    <aside className={`${isCollapsed ? 'w-20' : 'w-64'} transition-all duration-300 flex-shrink-0 border-r border-borderc bg-card h-full flex flex-col z-20`}>
      ...
      <div className="p-4 border-t border-borderc bg-muted/5 space-y-3">
        {/* Theme Toggle */}
        <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} gap-2`}>
          {!isCollapsed && <span className="text-sm text-muted">Tema</span>}
          <ThemeToggle />
        </div>
