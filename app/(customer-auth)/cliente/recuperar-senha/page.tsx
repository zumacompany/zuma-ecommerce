...
const copy = {
  pt: {
    ...
    emailSent:
      "Enviámos um link de recuperação para o seu email. Verifique a caixa de entrada.",
  ...
  en: {
    ...
    subtitle:
      "Request a secure link to reset the password for your Zuma account.",
...
export default function CustomerPasswordRecoveryPage() {
  ...
  const handleReset = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(
        resetError instanceof Error ? resetError.message : t("errors.generic"),
      );
    } finally {
      setLoading(false);
    }
