...
function CheckoutMessage({ title, body, tone = 'info' }: { title: string; body: string; tone?: 'info' | 'error' }) {
  ...
  return (
    <main className="py-12">
      <div className="container max-w-[640px] px-4">
        <div className={`rounded-2xl p-8 border shadow-sm text-center ${toneClass}`}>
